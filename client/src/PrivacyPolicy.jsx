...
const PrivacyPolicy = () => {
  return (
    <div style={{ margin: "30px" }} className="tos-container">
      <style
      ...
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">April 17, 2022</bdt>
                </span>
              </span>
            </strong>
          </span>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://limitless-harbor-62113.herokuapp.com/"
                      target="_blank"
        ...
        <div>
            ...
            <span style={{ fontSize: "15px" }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">flex4lease@gmail.com</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/a7a4c969-86e3-43d1-94af-fb27ab936b85"
