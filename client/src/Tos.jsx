const Tos = () => {
  return (
    <div style={{ margin: "90px 20px 0px 20px" }} className="terms-of-service">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to https://limitless-harbor-62113.herokuapp.com/!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of https://limitless-harbor-62113.herokuapp.com/'s Website, located at
        https://limitless-harbor-62113.herokuapp.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use
        https://limitless-harbor-62113.herokuapp.com/ if you do not agree to
      ...
      <p>
        ...
        https://limitless-harbor-62113.herokuapp.com/, you agreed to use cookies
        in agreement with the https://limitless-harbor-62113.herokuapp.com/'s
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, https://limitless-harbor-62113.herokuapp.com/
        and/or its licensors own the intellectual property rights for all
        material on https://limitless-harbor-62113.herokuapp.com/. All
        intellectual property rights are reserved. You may access this from
        https://limitless-harbor-62113.herokuapp.com/ for your own personal use
      ...
      <ul>
        <li>
          Republish material from https://limitless-harbor-62113.herokuapp.com/
        </li>
        <li>
      ...
      <p>
        ...
        https://limitless-harbor-62113.herokuapp.com/ does not filter, edit,
        publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of
        https://limitless-harbor-62113.herokuapp.com/,its agents and/or
        ...
        laws, https://limitless-harbor-62113.herokuapp.com/ shall not be liable
      ...
      <p>
        https://limitless-harbor-62113.herokuapp.com/ reserves the right to
      ...
      <p>
        You hereby grant https://limitless-harbor-62113.herokuapp.com/ a
      ...
      <p>
        ...
        https://limitless-harbor-62113.herokuapp.com/; and (d) the link is in
      ...
      <p>
        ...
        e-mail to https://limitless-harbor-62113.herokuapp.com/. Please include
        ...
        our Website, and a list of the URLs on our site to which you would like
      ...
      <p>
        No use of https://limitless-harbor-62113.herokuapp.com/'s logo or other
      ...
      <p>
        ...
        the use of this website. This website is for educational purposes only.
        You assume all risks and liabilities by using this site.
      </p>
